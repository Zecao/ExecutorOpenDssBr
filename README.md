...
In addition to **OpenDSSengine.dll** and the OpenDSS Extensions (from Unicamp), the project uses two other dll files: **EEPlus.dll** which allows Excel files to be read in the C# and **Auxiliares.dll**. All the dll files are included in this project.    
