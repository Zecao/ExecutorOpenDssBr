...
{
    public class FeederCharacteristiscs
    {
        ...
        public FeederCharacteristiscs(GeneralParameters paramGerais)
        {
            ...
            foreach (string nomeAlim in alimentadores)
            {
                ...
                DailyFlow _daily = new DailyFlow(_paramGerais, "DU", false);
                ...
                List<double> PVSystem_cap = Sum_PVSystemCap(_daily._oDSS._DSSObj.ActiveCircuit.PVSystems, _daily._oDSS._DSSText);
